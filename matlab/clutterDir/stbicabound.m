function lll = stbicabound(V, Sigma_V, lambda, XULinv, nu, sigma2_tau, a_beta, b_beta, a_alpha, b_alpha, sbar, ...
			   Sigma_s,  nubar_tau, sigma2bar_tau, abar_beta, ...
...
entropy_tau = 0;	  
for j = 1:latentDim
  entropy_tau = entropy_tau + stgamma_entropy(nubar_tau(j), sigma2bar_tau(:, ...
						  j));
end
